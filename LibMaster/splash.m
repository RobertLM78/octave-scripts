...
fprintf("This program comes with ABSOLUTELY NO WARRANTY; for details type `show w'\n")
fprintf("This is free software, and you are welcome to redistribute it\n")
fprintf("under certain conditions; type `show c' for details.  Otherwise press any key.")
